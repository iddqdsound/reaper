--[[
 * ReaScript Name: Separate audio from selected video item (group video and audio items)
 ...
 * Instructions: Select a video item. Run the action. the item will be copied and glued on a new track below current track
   ...
   This will also group both items so you can edit them together.
   If you don't want this behaviour, use the other action with no grouping!
